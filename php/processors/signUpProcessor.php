...
echo '</html>';
	...
	('userLastName')). ", Activate your DistilAir Airlines Login";
...
<html>
    <body>
        <h1>Welcome to DistilAir Airlines, Your Access to the Skies</h1>
        <hr />
        <p>Thank you for signing up for DistilAir-Air. Visit the following URL
